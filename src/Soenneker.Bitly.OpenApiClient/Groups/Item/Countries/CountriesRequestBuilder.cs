...
{
    /// <summary>
    /// Builds and executes requests for operations under \groups\{groupGuid}\countries
    /// </summary>
    ...
    public partial class CountriesRequestBuilder : BaseRequestBuilder
    {
        ...
        public CountriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{groupGuid}/countries?unit={unit}&units={units}{&size*,unit_reference*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bitly.OpenApiClient.Groups.Item.Countries.CountriesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CountriesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{groupGuid}/countries?unit={unit}&units={units}{&size*,unit_reference*}", rawUrl)
        {
        }
        /// <summary>
