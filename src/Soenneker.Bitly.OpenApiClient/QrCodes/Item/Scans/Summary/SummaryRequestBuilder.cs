...
{
    /// <summary>
    /// Builds and executes requests for operations under \qr-codes\{qrcodeId}\scans\summary
    /// </summary>
    ...
    public partial class SummaryRequestBuilder : BaseRequestBuilder
    {
        ...
        public SummaryRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/qr-codes/{qrcodeId}/scans/summary?unit={unit}&units={units}{&unit_reference*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bitly.OpenApiClient.QrCodes.Item.Scans.Summary.SummaryRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SummaryRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/qr-codes/{qrcodeId}/scans/summary?unit={unit}&units={units}{&unit_reference*}", rawUrl)
        {
        }
        /// <summary>
