...
namespace Soenneker.Bitly.OpenApiClient.QrCodes.Item.Scans.Browsers
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bitly.OpenApiClient.QrCodes.Item.Scans.Browsers.BrowsersRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Soenneker.Bitly.OpenApiClient.Models.ScanMetrics?> GetAsync(Action<RequestConfiguration<global::Soenneker.Bitly.OpenApiClient.QrCodes.Item.Scans.Browsers.BrowsersRequestBuilder.BrowsersRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Bitly.OpenApiClient.Models.ScanMetrics> GetAsync(Action<RequestConfiguration<global::Soenneker.Bitly.OpenApiClient.QrCodes.Item.Scans.Browsers.BrowsersRequestBuilder.BrowsersRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Bitly.OpenApiClient.QrCodes.Item.Scans.Browsers.BrowsersRequestBuilder.BrowsersRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Bitly.OpenApiClient.QrCodes.Item.Scans.Browsers.BrowsersRequestBuilder.BrowsersRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Bitly.OpenApiClient.QrCodes.Item.Scans.Browsers.BrowsersRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Bitly.OpenApiClient.QrCodes.Item.Scans.Browsers.BrowsersRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Bitly.OpenApiClient.QrCodes.Item.Scans.Browsers.BrowsersRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Returns the browsers generating scan traffic to the specified QR Code.
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class BrowsersRequestBuilderGetQueryParameters 
        {
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class BrowsersRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.Bitly.OpenApiClient.QrCodes.Item.Scans.Browsers.BrowsersRequestBuilder.BrowsersRequestBuilderGetQueryParameters>
        {
        }
    }
}
