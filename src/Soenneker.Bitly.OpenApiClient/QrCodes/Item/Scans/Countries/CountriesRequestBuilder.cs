...
{
    /// <summary>
    /// Builds and executes requests for operations under \qr-codes\{qrcodeId}\scans\countries
    /// </summary>
    ...
    public partial class CountriesRequestBuilder : BaseRequestBuilder
    {
        ...
        public CountriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/qr-codes/{qrcodeId}/scans/countries?unit={unit}&units={units}{&size*,unit_reference*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bitly.OpenApiClient.QrCodes.Item.Scans.Countries.CountriesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CountriesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/qr-codes/{qrcodeId}/scans/countries?unit={unit}&units={units}{&size*,unit_reference*}", rawUrl)
        {
        }
        /// <summary>
