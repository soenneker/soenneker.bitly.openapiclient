...
namespace Soenneker.Bitly.OpenApiClient.Custom_bitlinks.Item.Clicks
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bitly.OpenApiClient.Custom_bitlinks.Item.Clicks.ClicksRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Soenneker.Bitly.OpenApiClient.Models.Clicks?> GetAsync(Action<RequestConfiguration<global::Soenneker.Bitly.OpenApiClient.Custom_bitlinks.Item.Clicks.ClicksRequestBuilder.ClicksRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Bitly.OpenApiClient.Models.Clicks> GetAsync(Action<RequestConfiguration<global::Soenneker.Bitly.OpenApiClient.Custom_bitlinks.Item.Clicks.ClicksRequestBuilder.ClicksRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Bitly.OpenApiClient.Custom_bitlinks.Item.Clicks.ClicksRequestBuilder.ClicksRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Bitly.OpenApiClient.Custom_bitlinks.Item.Clicks.ClicksRequestBuilder.ClicksRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Bitly.OpenApiClient.Custom_bitlinks.Item.Clicks.ClicksRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Bitly.OpenApiClient.Custom_bitlinks.Item.Clicks.ClicksRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Bitly.OpenApiClient.Custom_bitlinks.Item.Clicks.ClicksRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Returns the click counts for the specified link. This returns an array with clicks based on a date.
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class ClicksRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.Bitly.OpenApiClient.Custom_bitlinks.Item.Clicks.ClicksRequestBuilder.ClicksRequestBuilderGetQueryParameters>
        {
        }
    }
}
